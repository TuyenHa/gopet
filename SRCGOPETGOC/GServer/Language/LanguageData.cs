...
namespace Gopet.Language
{
    public sealed class LanguageData
    {
        ...
        public string KioskItemLocked { get; set; } = "Vật phẩm đang khóa, bạn không thể bán được.";
        public string KioskNotOwner { get; set; } = "Vật phẩm này không phải của bạn";
        public string KioskInvalidPrice { get; set; } = "Giá phải từ 1 đến 2.000.000.000 (ngoc)";
        public string KioskInvalidCount { get; set; } = "Số lượng không hợp lệ";
        public string KioskItemNotFound { get; set; } = "Không tìm thấy vật phẩm trong túi đồ";
        public string KioskInvalidCategory { get; set; } = "Loại ki ốt không hợp lệ";
        public string KioskAssignedToOther { get; set; } = "Vật phẩm này chỉ bán cho người chơi có tên: {0}";
        public string KioskCannotAssignSelf { get; set; } = "Không thể chỉ định chính mình";
        public string KioskCannotSellActivePet { get; set; } = "Không thể bán pet đang theo cùng bạn";
        public string KioskExpiredReturned { get; set; } = "Vật phẩm ki ốt đã hết hạn và được trả về túi của bạn.";
        public string KioskPetHasEquip { get; set; } = "Vui lòng tháo hết trang bị của pet trước khi treo bán";
        public string KioskMaintenanceBlockList { get; set; } = "Sắp bảo trì không thể treo vật phẩm này";
        public string MarketSellSuccess { get; set; } = "Đăng bán vật phẩm thành công";
        public string ItemExpiredCannotSell { get; set; } = "Vật phẩm đã hết hạn, bạn không thể bán được.";
        ...
        /// <summary>Hậu tố map cho dòng diệt quái: {dòng yêu cầu} tại {danh sách map}.</summary>
        public string TASK_MOB_AT_MAP { get; set; } = "%s tại %s";
        /// <summary>Tab "Nhiệm vụ tiếp theo" — xem TaskGuide.</summary>
        public string TASK_GUIDE_READY { get; set; } = "Đến %s để nhận nhiệm vụ.";
        public string TASK_GUIDE_AFTER { get; set; } = "Hoàn thành %s rồi đến %s để nhận.";
        public string TASK_GUIDE_MAP_NPC { get; set; } = "%s gặp %s";
        public string TASK_GUIDE_MEET_NPC { get; set; } = "gặp %s";
        public string TASK_REQUEST_PET_LVL { get; set; } = "Pet đạt cấp %s/%s";
        public string TASK_REQUEST_LEARN_SKILL_PET { get; set; } = "Học kỹ năng cho thú cưng %s/%s";
        public string TASK_REQUEST_LEARN_SKILL2_PET { get; set; } = "Học kỹ năng thứ 2 cho thú cưng %s/%s";
        ...
        public string OnTaskSuccess { get; set; } = "Chúc mừng bạn đã hoàn thành {0}!\nPhần thưởng đã được gửi vào rương đồ: {1}";
